...
import { InfractionComponent } from 'app/entities/infraction/infraction.component';
...
describe('Component Tests', () => {
  describe('Infraction Management Component', () => {
    let comp: InfractionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InfractionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.infractions && comp.infractions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
