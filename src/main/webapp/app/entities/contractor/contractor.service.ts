...
type EntityResponseType = HttpResponse<IContractor>;
type EntityArrayResponseType = HttpResponse<IContractor[]>;
...
export class ContractorService {
  ...
  update(contractor: IContractor): Observable<EntityResponseType> {
    return this.http.put<IContractor>(this.resourceUrl, contractor, { observe: 'response' });
  }
