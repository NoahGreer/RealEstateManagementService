...
export class ApartmentComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.apartmentService
      ...
      .subscribe(
        (res: HttpResponse<IApartment[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInApartments(): void {
    this.eventSubscriber = this.eventManager.subscribe('apartmentListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IApartment[] | null, headers: HttpHeaders, page: number): void {
